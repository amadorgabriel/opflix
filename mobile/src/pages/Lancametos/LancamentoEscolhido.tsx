...
export default class LEscolhido extends Component {
  ...
  _carregarLancamento = async () => {
    ...
    this.setState({
      categoria: await AsyncStorage.getItem('@opflix:lancCategoria'),
    });
    this.setState({
      conteudo: await AsyncStorage.getItem('@opflix:lancConteudo'),
    });
          ...
          <View style={styles.lanc}>
            <View style={styles.header}>
              ...
              {this.state.boolFav == 'false' ? (
                <Image
                  source={require('../../assets/icons/completo.png')}
                ...
                <TouchableOpacity
                  ...
                  <Image
                    source={require('../../assets/icons/vazio.png')}
                    style={styles.iconFav}
                  />
                </TouchableOpacity>
              )}
