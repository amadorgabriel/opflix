...
export default class Lancamentos extends Component {
  ...
  static navigationOptions = {
    tabBarIcon: ({tintColor}) => (
      <Image
        source={require('../../assets/icons/iconL.png')}
        style={styles.icon}
        tintColor={tintColor}
      />
    ),
      ...
      <View style={{width: 400, alignItems: 'center', textAlign: 'center'}}>
        <TouchableOpacity
          ...
          <Image
            ...
            source={{
              uri:
                'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTeRsFqBXRkF6UpvXa7pIYhvSSDMp971kcMz9GjkXTwXxg5rRjA&s',
            }}
          />
        </TouchableOpacity>
      </View>
        ...
        <ScrollView>
          ...
          <View style={styles.divCat}>
            ...
            <FlatList
              ...
              renderItem={({item}) => (
                <TouchableOpacity onPress={this._carregarEscolhido}>
                  <View>
                    <TouchableOpacity
                      onPress={() => {
                        this._navegar(
                          item.idLancamentoNavigation.titulo,
                          item.idLancamentoNavigation.sinopse,
                          item.idLancamentoNavigation.duracao,
                          item.idLancamentoNavigation.dataLancamento,
                          item.idLancamentoNavigation.idCategoriaNavigation
                            .nome,
                          item.idLancamentoNavigation.fotoLanc,
                          item.idLancamentoNavigation.idTipoConteudoNavigation
                            .nome,
                          item.titulo,
                          item.idLancamento,
                        );
          ...
          {this.state.categoriasLs.map(x => {
            ...
            return (
              <View style={styles.divCat}>
                ...
                <FlatList
                  horizontal={true}
                  data={this.state.lancamentosLs.filter(y => {
                    return y.idCategoria === idCat;
                  })}
                  keyExtractor={item => item.idLancamento}
                      ...
                      <TouchableOpacity
                        onPress={() => {
                          this._navegar(
                            ...
                            item.duracao,
                            item.dataLancamento,
                            item.idCategoriaNavigation.nome,
                            item.fotoLanc,
                            item.idTipoConteudoNavigation.nome,
                            item.titulo,
                            item.idLancamento,
                          );
                        }}>
